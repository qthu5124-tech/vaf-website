...
const newsData = [
    {
        id: 'cach-do-kich-thuoc-loc-khi-ahu-hepa',
        ...
        faq: [
            { question: 'Đo kích thước lọc khí theo thứ tự nào?', answer: 'Ghi rõ rộng × cao × sâu hoặc dày, đơn vị mm, theo hướng nhìn vào mặt lọc. Đánh dấu từng chiều trên ảnh hoặc bản vẽ để tránh nhầm quy ước của nhà cung cấp.' },
            { question: 'Kích thước lọc HEPA có bao gồm gioăng không?', answer: 'Cần đối chiếu bản vẽ của đúng model. Khi đo hiện trường, ghi riêng kích thước khung và độ dày gioăng chưa nén, kèm ảnh vị trí làm kín; không tự cộng gioăng vào chiều dày khung.' },
        ...
        content: `
            ...
            <h2 id="quy-uoc" class="text-3xl font-bold text-secondary mt-10 mb-6">1. Phân biệt kích thước danh nghĩa và kích thước thực</h2>
            <p class="mb-5 leading-8">Kích thước danh nghĩa là cách gọi quy cách; kích thước thực là số đo của bộ lọc được sản xuất. Hai giá trị này có thể khác nhau. Không tự lấy tên quy cách để suy ra kích thước đặt hàng, và không tự trừ một khoảng hở cố định cho mọi khung giữ.</p>
            <p class="mb-5 leading-8">Cũng cần phân biệt kích thước bộ lọc với kích thước ô lắp. Khi khung giữ bị biến dạng hoặc bộ lọc cũ đã từng lắp sai, chỉ sao chép mẫu cũ có thể lặp lại lỗi. Hãy đối chiếu mẫu lọc, bản vẽ và vị trí lắp thực tế.</p>
            <div class="bg-slate-50 rounded-xl p-6 my-8"><strong>Ví dụ cách ghi, không phải quy cách khuyến nghị:</strong><p class="mt-3 leading-7">“Khung lọc: rộng 592 × cao 592 × dày 48 mm; gioăng nằm ở mặt khí ra, ghi độ dày riêng; ảnh mặt trước và mặt cạnh đính kèm.” Chỉ sử dụng các con số đã đo hoặc đã được xác nhận trên bản vẽ của bộ lọc cần đặt.</p></div>
            <h2 id="cach-do" class="text-3xl font-bold text-secondary mt-10 mb-6">2. Các bước đo kích thước lọc khí tại hiện trường</h2>
            <ol class="list-decimal pl-6 space-y-4 mb-8">
                <li><strong>Chuẩn bị thông tin:</strong> chụp nhãn lọc, mã AHU/FFU, chiều gió và vị trí lắp trước khi tháo. Việc tiếp cận hoặc tháo lọc cần do người được phân công thực hiện theo quy trình dừng máy và bảo trì của cơ sở.</li>
                <li><strong>Đo chiều rộng và chiều cao:</strong> đo từ mép ngoài khung này đến mép ngoài đối diện. Không đo riêng vùng vật liệu lọc bên trong. Ghi hướng nhìn và đánh dấu từng chiều trên ảnh.</li>
                <li><strong>Đo chiều sâu hoặc độ dày:</strong> đo phần khung theo hướng dòng khí; ghi riêng phần nhô ra, mặt bích, gioăng hoặc rãnh gel. Không tì thước vào giấy lọc hay làm biến dạng nếp gấp.</li>
                <li><strong>Kiểm tra điểm làm kín:</strong> ghi vị trí gioăng, số mặt có gioăng, cơ cấu kẹp và hướng lắp. Với kiểu gel seal, gửi ảnh rãnh gel và chi tiết ghép kín để đối chiếu.</li>
                <li><strong>Đối chiếu khung giữ:</strong> kiểm tra ô lắp, ray, độ sâu khả dụng và các vật cản phía sau. Nếu số đo khác bản vẽ hoặc khung bị cong, cần xác nhận lại trước khi đặt.</li>
            </ol>
            <h2 id="tung-loai" class="text-3xl font-bold text-secondary mt-10 mb-6">3. Mỗi loại lọc cần thêm thông tin gì?</h2>
            <div class="overflow-x-auto my-8 rounded-xl border border-slate-200"><table class="w-full min-w-[640px] text-left border-collapse"><thead class="bg-secondary text-white"><tr><th scope="col" class="p-4">Loại lọc</th><th scope="col" class="p-4">Thông tin cần đo hoặc ghi</th><th scope="col" class="p-4">Lỗi dễ gặp</th></tr></thead><tbody><tr class="border-b"><td class="p-4 font-bold">Lọc thô dạng tấm</td><td class="p-4">Kích thước khung, chiều dày, vật liệu khung, vị trí gioăng</td><td class="p-4">Đo vùng lọc thay cho phủ bì khung</td></tr><tr class="border-b bg-slate-50"><td class="p-4 font-bold">Lọc túi AHU</td><td class="p-4">Rộng/cao khung, độ dày đầu khung, chiều dài túi, số túi</td><td class="p-4">Nhầm chiều sâu túi với chiều dày đầu khung</td></tr><tr><td class="p-4 font-bold">HEPA / ULPA</td><td class="p-4">Rộng/cao/sâu khung, mặt bích, kiểu gioăng hoặc gel seal, cơ cấu kẹp</td><td class="p-4">Đặt đúng kích thước nhưng sai kiểu làm kín</td></tr></tbody></table></div>
            <p class="mb-5 leading-8">Với lọc túi, cùng kích thước mặt trước vẫn có thể khác số túi, chiều sâu và đặc tính vận hành. Cần kiểm tra khoảng trống để túi làm việc mà không chạm các bộ phận phía sau. Xem thêm <a href="/news/cach-chon-loc-tui-f7-f8-f9-cho-ahu" class="text-primary font-bold hover:underline">cách chọn lọc túi F7, F8, F9 cho AHU</a> và <a href="/product/v-pakf8" class="text-primary font-bold hover:underline">thông số V-PAK F8</a>.</p>
            <figure class="my-10 max-w-3xl mx-auto"><img src="/images/san-pham/vpf8.webp" width="2400" height="1792" alt="Lọc túi V-PAK F8 VAF: cần ghi riêng kích thước khung và chiều sâu túi khi đặt hàng" loading="lazy" decoding="async" class="w-full h-auto rounded-xl"><figcaption class="text-sm text-slate-500 text-center mt-3">Ảnh sản phẩm V-PAK F8 của VAF; hình ảnh không thay thế bản vẽ kích thước của model đặt hàng.</figcaption></figure>
            <p class="mb-5 leading-8">Với HEPA, ghi rõ làm kín bằng gioăng hay gel. Tham khảo <a href="/product/ultracel-ii-gel" class="text-primary font-bold hover:underline">Ultracel II-GEL</a> để nhận diện dòng gel seal. Không suy ra cấp H13/H14 từ hình dáng hoặc kích thước; hãy đối chiếu nhãn và tài liệu kỹ thuật. Bài <a href="/news/so-sanh-loc-hepa-h13-va-h14" class="text-primary font-bold hover:underline">so sánh HEPA H13 và H14</a> giải thích thêm cách lựa chọn cấp lọc.</p>
            <h2 id="mau-bao-gia" class="text-3xl font-bold text-secondary mt-10 mb-6">4. Mẫu thông tin gửi yêu cầu báo giá</h2>
            <p class="mb-5 leading-8">Bạn có thể sao chép mẫu dưới đây. Mục nào chưa biết hãy ghi “chưa xác định” để kỹ sư hỗ trợ đối chiếu, thay vì ước đoán.</p>
            <div class="bg-slate-50 border border-slate-200 rounded-2xl p-6 leading-8"><p>Loại lọc / mã trên nhãn: …<br>Kích thước khung rộng × cao × sâu (mm): …<br>Gioăng / gel seal / mặt bích: …<br>Số túi và chiều dài túi (nếu có): …<br>Cấp lọc và tiêu chuẩn trên nhãn: …<br>Lưu lượng, chênh áp theo tài liệu (nếu có): …<br>Số lượng và địa điểm giao hàng: …<br>Ảnh nhãn + ảnh mặt trước + ảnh cạnh + ảnh ô lắp: …</p></div>
            <p class="mt-5 mb-5 leading-8">Giá còn phụ thuộc vật liệu khung, vật liệu lọc, cấu hình làm kín, số lượng và yêu cầu kiểm tra. Vì vậy, hai bộ lọc cùng kích thước chưa chắc có cùng giá hoặc thay thế được cho nhau.</p>
            <h2 id="faq" class="text-3xl font-bold text-secondary mt-10 mb-6">5. Câu hỏi thường gặp</h2>
            <div class="space-y-5"><div><h3 class="text-xl font-bold mb-2">Đo kích thước lọc khí theo thứ tự nào?</h3><p>Ghi rõ rộng × cao × sâu hoặc dày, đơn vị mm, theo hướng nhìn vào mặt lọc. Đánh dấu từng chiều trên ảnh hoặc bản vẽ để tránh nhầm quy ước của nhà cung cấp.</p></div><div><h3 class="text-xl font-bold mb-2">Kích thước lọc HEPA có bao gồm gioăng không?</h3><p>Cần đối chiếu bản vẽ của đúng model. Khi đo hiện trường, ghi riêng kích thước khung và độ dày gioăng chưa nén, kèm ảnh vị trí làm kín; không tự cộng gioăng vào chiều dày khung.</p></div><div><h3 class="text-xl font-bold mb-2">Không còn nhãn lọc cũ thì có đặt hàng được không?</h3><p>Có thể gửi ảnh bộ lọc, khung giữ, kích thước và ứng dụng để VAF tư vấn. Cấp lọc, lưu lượng và chênh áp vẫn cần xác nhận từ hồ sơ thiết kế hoặc người phụ trách kỹ thuật trước khi chốt cấu hình.</p></div></div>
            <section class="bg-secondary text-white rounded-2xl p-7 my-10"><h2 class="text-2xl font-bold mb-4">Gửi kích thước hoặc ảnh nhãn lọc cho VAF</h2><p class="leading-8 mb-5">VAF tiếp nhận thông số để tư vấn bộ lọc thay thế cho AHU, FFU và phòng sạch. Nếu chưa rõ cách đo, hãy gửi ảnh trước để trao đổi với đội ngũ tư vấn.</p><div class="flex flex-wrap gap-3"><a href="/bao-gia-loc-khi-theo-kich-thuoc" class="bg-primary text-white font-bold rounded-xl px-5 py-3">Nhận báo giá theo kích thước</a><a href="https://zalo.me/0817250442" target="_blank" rel="noopener" class="bg-white text-secondary font-bold rounded-xl px-5 py-3">Gửi ảnh qua Zalo 0817 250 442</a><a href="tel:19008949" class="border border-white rounded-xl px-5 py-3 font-bold">Gọi 1900 8949</a></div></section>
            <p class="text-sm text-slate-500 leading-7">Tham khảo kỹ thuật: <a href="https://www.camfil.com/en-my/products/general-ventilation-filters/bag-filters/hi-flo/hi-flo-_-34145" target="_blank" rel="noopener" class="underline">bảng thông số lọc túi Hi-Flo của Camfil</a> tách riêng rộng, cao, sâu, lưu lượng, chênh áp và số túi. Khi đặt lọc VAF, sử dụng tài liệu của đúng model VAF để xác nhận thông số.</p>
        `
    },
