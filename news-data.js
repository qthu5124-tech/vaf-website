...
const newsData = [
...

    {
        ...
        date: '06/07/2026',
        excerpt: 'HEPA Filter là bộ lọc không khí hiệu suất cao được sử dụng rộng rãi trong phòng sạch, bệnh viện, điện tử và dược phẩm. Tìm hiểu cấu tạo, nguyên lý hoạt động và ứng dụng thực tế của HEPA Filter.',
        content: `
