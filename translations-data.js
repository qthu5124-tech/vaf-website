window.translations = {
    'vi': {
        ...
        'news_page_title': 'Tin Tức & Sự Kiện',
        'news_page_desc': 'Cập nhật hoạt động sản xuất và công nghệ mới nhất từ VAF.',
        'news_filter_all': 'Tất cả',
        'news_filter_activity': 'Hoạt động',
        'news_filter_projects': 'Dự án',
        'news_filter_technology': 'Công nghệ',
        'news_featured': 'Bài Viết Nổi Bật',
        'news_subscribe': 'Đăng ký nhận bản tin',
        'news_subscribe_desc': 'Nhận thông tin kỹ thuật và báo giá mới nhất.',
        'news_subscribe_button': 'Đăng Ký',
        'news_back': 'Quay lại danh sách tin tức',
        ...
        'contact_direct_call': 'Gọi 0817 250 442',
        'contact_zalo': 'Nhắn Zalo báo giá',
        'contact_direct_adviser': 'Tư vấn trực tiếp & Zalo',
        'contact_open_zalo': 'Mở trò chuyện Zalo →',
        ...
        'contact_add': 'Lô C3.4, đường N14, KCN Đồng An 2,Phường Bình Dương, TP. Hồ Chí Minh, Việt Nam.',
        ...
        'contact_hero_title': 'Nhận Tư Vấn <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-white">Lọc Khí & Phòng Sạch</span>',
        'contact_hero_desc': 'Gửi kích thước, lưu lượng, cấp lọc hoặc hình ảnh sản phẩm đang sử dụng. VAF sẽ hỗ trợ lựa chọn cấu hình và báo giá phù hợp.',
        ...
        'form_pro_desc': 'Vui lòng cung cấp chi tiết nhu cầu, đội ngũ VAF sẽ tiếp nhận và phản hồi trong giờ làm việc.',
        'lbl_name': 'Họ & Tên *',
        'lbl_phone': 'Số Điện Thoại *',
        'lbl_company': 'Tên Công Ty',
    ...
    'en': {
        ...
        'contact_add': 'Lot C3.4, N14 Road, Dong An 2 Industrial Park, Binh Duong Ward, Ho Chi Minh City',
        ...
        'contact_hero_title': 'Get Advice on <br><span class="text-transparent bg-clip-text bg-gradient-to-r from-gray-300 to-white">Air Filters & Cleanrooms</span>',
        'contact_hero_desc': 'Send the dimensions, airflow, filter class or a photo of the current product. VAF will recommend a suitable configuration and quotation.',
        ...
        'form_pro_desc': 'Please provide your requirements. The VAF team will review and respond during business hours.',
        'lbl_name': 'Full Name *',
        'lbl_phone': 'Phone Number *',
        'lbl_company': 'Company',
        ...
        'news_page_desc': 'The latest VAF manufacturing activities and technology updates.',
        'news_filter_all': 'All',
        'news_filter_activity': 'Activities',
        'news_filter_projects': 'Projects',
        'news_filter_technology': 'Technology',
        'news_featured': 'Featured Articles',
        'news_subscribe': 'Subscribe to our newsletter',
        'news_subscribe_desc': 'Receive the latest technical updates and quotations.',
        'news_subscribe_button': 'Subscribe',
        ...
        'contact_direct_call': 'Call +84 817 250 442',
        'contact_zalo': 'Message on Zalo',
        'contact_direct_adviser': 'Direct adviser & Zalo',
        'contact_open_zalo': 'Open Zalo chat →',
